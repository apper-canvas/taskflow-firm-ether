              ...
              <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
                <Layout>
                  <Routes>
                    ...
                    <Route path="/today" element={<TaskListPage />} />
                    <Route path="/overdue" element={<TaskListPage />} />
                    <Route path="/completed" element={<TaskListPage />} />
                    <Route path="/upcoming" element={<TaskListPage />} />
